...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into attendence values ('" + TextBox1.Text + "'," + Convert.ToInt32(TextBox2.Text) + "," + TextBox3.Text + "," + TextBox4.Text + "," + TextBox5.Text + "," + TextBox6.Text + "," + TextBox7.Text + "," + TextBox8.Text + ")", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
